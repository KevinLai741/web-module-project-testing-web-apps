...
test('renders ONE error message if user enters a valid first name and last name but no email.', async () => {
    ...
    userEvent.type(lastNameField, "lai");
...
test('renders "email must be a valid email address" if an invalid email is entered', async () => {
    ...
    userEvent.type(emailField, "kevinlai@gmail");
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    userEvent.type(firstNameField, "kevin");
    userEvent.type(lastNameField, "lai");
    userEvent.type(emailField, "kevinlai@gmail.com");
    ...
    await waitFor(() => {
        ...
        const lastNameDisplay = screen.queryByText("lai");
        const emailDisplay = screen.queryByText("kevinlai@gmail.com");
...
test('renders all fields text when all fields are submitted.', async () => {
    ...
    await waitFor(() => {
        ...
        const lastNameDisplay = screen.queryByText(/lai/i);
        const emailDisplay = screen.queryByText(/kevinlai@gmail.com/i);
